...
import {
  ...
  LogOut, ChevronRight, BarChart2, Target, Building2, Database, Users, Sparkles, FileClock, Sprout, Trophy, Scale,
} from "lucide-react";
...
const navGroups = [
  ...
  { title: "Oportunidades", items: [
    ...
    { href: "/dashboard/winners",   label: "Vencedores", icon: Trophy },
